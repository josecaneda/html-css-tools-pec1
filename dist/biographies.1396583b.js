const biographyTextNeilArmstrong = `<p>Neil Armstrong nació el 5 de agosto de 1930 en Wapakoneta, en 
    ...
    `;
const biographyTextBuzzAldrin = `Edwin Eugene Aldrin Jr. nació el 20 de enero de 1930 en el 
    ...
    rango de «principiante».`;
const biographyTextPeteConrad = `Conrad nació en Filadelfia, Estado de Pensilvania (EE. UU.). 
    ...
    considerado para la misión Mercury 7, pero finalmente fue rechazado.`;
const biographyTextAlanBean = `Bean nació el 15 de marzo de 1932 en Wheeler, la sede del condado de Wheeler, 
    en el noreste de Texas Panhandle. Era de ascendencia escocesa. 
    De niño, vivió en Minden, la sede de Webster Parish en el noroeste de Louisiana, 
    donde su padre trabajaba para el Servicio de Conservación de Suelos de los Estados Unidos. 
    Se graduó de R. L. Paschal High School en Fort Worth, Texas, en 1950. Bean recibió una licenciatura en Ingeniería Aeronáutica de la Universidad de Texas 
    ...
    pilotando el F9F Cougar y A4D Skyhawk. Después de un período de servicio de cuatro años,
    ...
    cual fue seleccionado como astronauta de la NASA. Bean era un Boy Scout y obtuvo el 
    rango de Primera Clase`;
const biographyTextAlanShepard = `Nació el 18 de noviembre de 1923 en el estado nororiental de Nuevo Hampshire, 
    ...
    astronauta. Llegó a registrar más de 216 horas en el espacio a bordo de dos naves espaciales.
    Bean recibió una licenciatura en Ingeniería Aeronáutica de la Universidad de Texas 
    en Austin en 1955. En UT fue miembro de la fraternidad Delta Kappa Epsilon 
    (capítulo de Omega Chi). Fue comisionado como alférez de la Armada de los Estados Unidos 
    a través del Cuerpo de Entrenamiento de Oficiales de Reserva Naval en UT Austin, asistió 
    a entrenamientos de vuelo. Después de completar el entrenamiento de vuelo, fue asignado 
